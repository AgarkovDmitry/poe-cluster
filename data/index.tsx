...
export const clusterEffects = [
  { text: 'Area Damage', clusterType: 'medium', id: '' },
  ...
  { text: 'Brand Damage', clusterType: 'medium', id: '' },
  { text: 'Chance to Block Attack Damage', clusterType: 'small', id: '' },
  { text: 'Chance to Block Spell Damage', clusterType: 'small', id: '' },
  { text: 'Chance to Dodge Attacks', clusterType: 'small', id: '' },
  { text: 'Channelling Skill Damage', clusterType: 'medium', id: '' },
  { text: 'Chaos Damage', clusterType: 'large', id: '' },
  { text: 'Chaos Damage over Time Multiplier', clusterType: 'medium', id: '' },
  { text: 'Chaos Resistance', clusterType: 'small', id: '' },
  { text: 'Cold Damage', clusterType: 'large', id: '' },
  { text: 'Cold Damage over Time Multiplier', clusterType: 'medium', id: '' },
  { text: 'Cold Resistance', clusterType: 'small', id: '' },
  { text: 'Critical Chance', clusterType: 'medium', id: '' },
  { text: 'Curse Effect', clusterType: 'medium', id: '' },
  ...
  { text: 'Evasion', clusterType: 'small', id: '' },
  { text: 'Exerted Effect', clusterType: 'medium', id: '' },
  { text: 'Fire Damage', clusterType: 'large', id: '' },
  { text: 'Fire Damage over Time Multiplier', clusterType: 'medium', id: '' },
  { text: 'Fire Resistance', clusterType: 'small', id: '' },
  { text: 'Flask Duration', clusterType: 'medium', id: '' },
  { text: 'Life', clusterType: 'small', id: '' },
  { text: 'Life and Mana recovery from Flasks', clusterType: 'medium', id: '' },
  { text: 'Lightning Damage', clusterType: 'large', id: '' },
  { text: 'Lightning Resistance', clusterType: 'small', id: '' },
  ...
  { text: 'Trap and Mine Damage', clusterType: 'medium', id: '' },
  { text: 'Wand Damage', clusterType: 'large', id: '' },
]
